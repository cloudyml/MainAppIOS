...
class _VideoScreenState extends State<VideoScreen> {
  ...
  List<QueryDocumentSnapshot<Map<String, dynamic>>>? _listOfVideoDocuments;
  ...
  void setupPlaylistConfiguration() {
  ...
  Future<List<BetterPlayerDataSource>> setupData() async {
    // for (var videoDoc in _listOfVideoDocuments!) {
    //   print('Added');
    //   _dataSourceList.add(
  ...
  //     setState(() {
  //       print(value.docs);
  //       _listOfVideoDocuments = value.docs;
  //       for (var doc in _listOfVideoDocuments!) {
  //         print(doc.data());
  //       }

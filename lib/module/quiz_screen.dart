...
class QuizPage extends StatefulWidget {
  ...
  QuizPage(
      /*{this.sr, this.levelid, this.sub, this.chapterid, this.chaptername}*/);
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: InkWell(
              ...
              child: Container(
                  height: MediaQuery.of(context).size.height * 0.035, //30
                  decoration:
                          ...
                          children: [
                            ...
                            AnimatedOpacity(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                    color: Colors.red, fontFamily: 'Bold'),
                              ),
                            ),
                            SizedBox(
                              height: 10,
...
class QuizOptions extends StatefulWidget {
  final List? list;
  final int? index;
  QuizOptions({this.list, this.index});
                            ...
                            Container(
                              ...
                              child: Transform.scale(
                                ...
                                child: Checkbox(
                                    ...
                                    checkColor: Color(0xFFaefb2a),
                                    shape: CircleBorder(),
                                    activeColor: Color(0xFFaefb2a),
